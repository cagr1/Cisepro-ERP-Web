<template>
  <div class="min-h-screen bg-gray-10 p-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-4">
            ...
            <div class="space-y-2">
              <div class="flex flex-col items-center justify-center">
                <div class="w-20 h-20 rounded-full bg-gray-200 mb-2 overflow-hidden border-2 border-white shadow-sm">
                  <img v-if="formData.foto" 
                  :src="formData.foto"
                ...
                <label for="dropzone-file" class="text-xs text-blue-600 hover:text-blue-800 cursor-pointer">
                  Cambiar foto
              ...
              <div class="py-1">
                ...
                <input type="number" v-model="formData.edad"
              ...
              <div>
                ...
                <input type="text" v-model="formData.provincia" class="w-max-[160px] form-field" />
              </div>
              <div>
            ...
            <div class="space-y-2">
              ...
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Id Personal</label>
                <input type="text" v-model="formData.idPersonal"
                  class="max-w-[130px] h-8 px-2 text-xs border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-0 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Email</label>
                <input type="email" v-model="formData.email" class="max-w-[160px] form-field" />
              </div>
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Ciudad</label>
                <input type="text" v-model="formData.ciudad" class="form-field max-w-[160px]" />
              </div>

              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Tipo Cta</label>
                <select v-model="formData.tipoCta" class="form-field max-w-[160px]">
            ...
            <div class="space-y-2">
              <div>
                ...
                <input type="text" v-model="formData.nombres" class="w-max-[160px] form-field" />
              </div>
              <div>
              ...
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Parroquia</label>
                <input type="text" v-model="formData.parroquia" class="form-field max-w-[160px]" />
              </div>
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">CTA Banco</label>
                <input type="text" v-model="formData.ctaBanco" class="form-field max-w-[160px]" />
              </div>
            </div>
            ...
            <div class="space-y-2">
              <div>
                ...
                <input type="text" v-model="formData.apellidos" class="w-max-[160px] form-field" />
              </div>
              <div>
              ...
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Estatura</label>
                <input type="number" v-model="formData.estatura"
                  class="max-w-[100px] h-8 px-2 text-xs border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-0 focus:ring-blue-500 focus:border-blue-500" />
              </div>
              <div>
            ...
            <div class="space-y-2">
              ...
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Instrucción Primaria</label>
                <select v-model="formData.instruccion" class="form-field max-w-[160px]">
                  <option
              ...
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Tipo Sangre</label>
                <select v-model="formData.tipoSangre"
              ...
              <div>
                ...
                <input type="tel" v-model="formData.nroContrato"
                  class="max-w-[100px] h-8 px-2 text-xs border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-0 focus:ring-blue-500 focus:border-blue-500" />
              </div>

              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Credencial</label>
                <input type="checkbox" v-model="formData.credencial" class="w-4 h-4 p-0" />
              </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb4">
            ...
            <div class="space-y-2">
              <div>
                ...
                <input type="date" v-model="formData.fechaIngreso" class="form-field w-full" />
              </div>
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Ubicacion</label>
                <input type="text" v-model="formData.pagoRol" class="form-field w-full h-20" />
              </div>
              <div>
            ...
            <div class="space-y-2">
              <div>
                ...
                <input type="date" v-model="formData.fechaSalida" class="form-field w-full" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="date" v-model="formData.inicioProyecto" class="form-field w-full" />
              </div>
            ...
            <div class="space-y-2">
              ...
              <div>
                ...
                <textarea v-model="formData.observacion" class="form-field w-full h-20"></textarea>
              </div>
              <div>
                ...
                >
                <input
                  type="date" v-model="formData.inicioProyecto" class="form-field w-full" />
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center gap-2">
                <input type="checkbox" v-model="formData.afiliadoIESS"
                  class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" id="afiliadoIESS" />
                <label class="text-xs font-medium text-gray-600 cursor-pointer" for="afiliadoIESS">
                  Afiliado IESS
                </label>
              </div>
              <!-- Fecha de Afiliación (siempre visible) -->
              <div>
                <label class="block text-xs font-medium text-gray-600 mb-1">Fecha Afiliación</label>
                <input type="date" v-model="formData.fechaAfiliacionIESS" :disabled="!formData.afiliadoIESS"
                  class="form-field w-full" :class="{
              ...
              <div class="flex items-center gap-2">
                <input type="checkbox" v-model="formData.xiii" :disabled="!formData.afiliadoIESS"
                  class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" :class="{
                    'opacity-50 cursor-not-allowed': !formData.afiliadoIESS,
                  }" id="XIII" />
                <label class="text-xs font-medium text-gray-600 cursor-pointer" for="XIII">
                  XIII Sueldo
                </label>
              </div>
              ...
              <div class="flex items-center gap-2">
                <input type="checkbox" v-model="formData.xiv" :disabled="!formData.afiliadoIESS"
                  class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" :class="{
                    'opacity-50 cursor-not-allowed': !formData.afiliadoIESS,
                  }" id="XIV" />
                <label class="text-xs font-medium text-gray-600 cursor-pointer" for="XIV">
                  XIV Sueldo
                </label>
              </div>
              ...
              <div class="flex items-center gap-2">
                <input type="checkbox" v-model="formData.fondoReserva" :disabled="!formData.afiliadoIESS"
                  class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" :class="{
                    'opacity-50 cursor-not-allowed': !formData.afiliadoIESS,
                  }" id="fondoReserva" />
                <label class="text-xs font-medium text-gray-600 cursor-pointer" for="fondoReserva">
                  Fondo de Reserva
                </label>
              </div>
              ...
              <div class="flex items-center gap-2">
                <input type="checkbox" v-model="formData.acumFondoReserva" :disabled="!formData.afiliadoIESS"
                  class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" :class="{
                    'opacity-50 cursor-not-allowed': !formData.afiliadoIESS,
                  }" id="acumFondoReserva" />
                <label class="text-xs font-medium text-gray-600 cursor-pointer" for="acumFondoReserva">
                  Acumulado F. Reserva
                </label>
              </div>
            </div>
            ...
            <div class="space-y-2">
              ...
              <div class="flex items-center gap-2">
                <input type="checkbox" v-model="formData.historiaClinica"
                  class="h-4 w-4 text-blue-600 border-gray-300 rounded" id="historiaClinica" />
              ...
              <div class="flex flex-col gap-1">
                <div class="flex items-center gap-2">
                  <input type="checkbox" v-model="formData.discapacitado"
                    class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" id="discapacitado" />
                  <label class="text-xs font-medium text-gray-600 cursor-pointer"
                    for="discapacitado">Discapacitado</label>
                </div>
                <input v-if="formData.discapacitado" type="text" v-model="formData.discapacitadoDetalle"
              ...
              <div class="flex flex-col gap-1">
                <div class="flex items-center gap-2">
                  <input type="checkbox" v-model="formData.examenPsicologico"
                    class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" id="examenPsicologico" />
                  <label class="text-xs font-medium text-gray-600 cursor-pointer" for="examenPsicologico">Examen
                    Psicológico</label>
                </div>
                <input v-if="formData.examenPsicologico" type="text" v-model="formData.examenPsicologicoDetalle"
                  class="w-full h-8 px-2 text-xs border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-0 focus:ring-blue-500 focus:border-blue-500 ml-6"
                  placeholder="Número o serie" />
              </div>
              ...
              <div class="flex flex-col gap-1">
                <div class="flex items-center gap-2">
                  <input type="checkbox" v-model="formData.cursoVigilante"
                    class="h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500" id="cursoVigilante" />
                  <label class="text-xs font-medium text-gray-600 cursor-pointer" for="cursoVigilante">Curso
                    Vigilante</label>
                </div>
                <input v-if="formData.cursoVigilante" type="text" v-model="formData.cursoVigilanteDetalle"
                  class="w-full h-8 px-2 text-xs border border-gray-300 rounded shadow-sm focus:outline-none focus:ring-0 focus:ring-blue-500 focus:border-blue-500 ml-6"
                  placeholder="Número o serie" />
              </div>
            </div>
    ...
    <SearchModal :show="showSearchModal" :items="searchResults" :current-page="currentPage"
      :items-per-page="itemsPerPage" :total-items="totalItems" :total-pages="totalPages" :is-loading="isLoading"
      :page-size-options="pageSizeOptions" @search="buscarPersonal" @close="showSearchModal = false"
      @select="loadEmployee" @page-change="handlePageChange" @change-page-size="handlePageSizeChange" />
  </div>
</template>
...
const loadEmployee = async(employee) => {
  ...
  if (contratoResponse.success && contratoResponse.data) {
    Object.assign(formData, {
        ...
        area: contratoResponse.data.area,
  ...
  toast.error("Error al cargar los datos del empleado: ", 
    {
      description: error.message || "Ocurrió un error al cargar los datos del empleado.",
      duration: 5000,
    }
  );
