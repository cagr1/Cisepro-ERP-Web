...
public partial class ComprobanteReingresoBodega
{
    ...
    public virtual ICollection<DetalleComprobanteReingresoBodega> DetalleComprobanteReingresoBodegas { get; set; } = new List<DetalleComprobanteReingresoBodega>();
}
