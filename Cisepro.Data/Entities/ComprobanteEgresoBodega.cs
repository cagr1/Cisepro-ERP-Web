...
public partial class ComprobanteEgresoBodega
{
    ...
    public virtual ICollection<DetalleComprobanteEgresoBodega> DetalleComprobanteEgresoBodegas { get; set; } = new List<DetalleComprobanteEgresoBodega>();
}
