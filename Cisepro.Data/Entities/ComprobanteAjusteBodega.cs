...
public partial class ComprobanteAjusteBodega
{
    ...
    public virtual ICollection<DetalleComprobanteAjusteBodega> DetalleComprobanteAjusteBodegas { get; set; } = new List<DetalleComprobanteAjusteBodega>();
}
